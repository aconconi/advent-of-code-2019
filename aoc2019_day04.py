...
# generate indexable digits from number
# using strings makes the rest of the program faster
def number_to_digits(n):
    return str(n)

# alternative implementation 2
# using lists makes the rest of the program faster
def number_to_digits2(n):
    def get_digit(n, i):
        return n // 10**i % 10
    return [ get_digit(n, i) for i in reversed(range(len(str(n)))) ]
